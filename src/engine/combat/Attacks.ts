...
export const ATTACKS: Record<string, AttackDef> = {
  ...
  swordAir: A({ id: 'swordAir', label: 'Corte Aéreo', windup: 0.16, active: 0.12, recovery: 0.24, damage: 18, strength: 0.6, knockback: 5, hitStop: 0.07, shake: 0.28, arc: [165, -72], roll: 90, pitch: 0, lunge: 0, cancelAt: 0.1, whoosh: 0.7, bodyMotion: 0.35, overhead: true }),
