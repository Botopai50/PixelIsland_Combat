...
export const ATTACKS: Record<string, AttackDef> = {
  ...
  axeCharged: A({ id: 'axeCharged', label: 'Machadada Carregada', windup: 0.08, active: 0.12, recovery: 0.55, damage: 45, strength: 1, knockback: 6, hitStop: 0.15, shake: 0.6, arc: [102, -25], roll: -4, pitch: 14, pivot: 'chest', lunge: 0, cancelAt: 0.3, whoosh: 1, bodyTwist: 0.6, stamina: 25, work: 'chop' }),
