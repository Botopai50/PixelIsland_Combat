...
export const ATTACKS: Record<string, AttackDef> = {
  ...
  swordSpin: A({ id: 'swordSpin', label: 'Ataque Giratório', windup: 0.05, active: 0.42, recovery: 0.36, damage: 28, strength: 0.85, knockback: 7, hitStop: 0.1, shake: 0.4, arc: [100, -460], roll: -10, pitch: 4, pivot: 'center', lunge: 0, cancelAt: 0.2, whoosh: 0.9, spin: true, stamina: 25 }),
