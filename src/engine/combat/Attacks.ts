...
export const ATTACKS: Record<string, AttackDef> = {
  ...
  swordSpin: A({ id: 'swordSpin', label: 'Ataque Giratório', windup: 0.05, active: 0.42, recovery: 0.36, damage: 28, strength: 0.85, knockback: 7, hitStop: 0.1, shake: 0.4, arc: [100, -300], roll: -10, pitch: 4, pivot: 'center', lunge: 0, cancelAt: 0.2, whoosh: 0.9, spin: true, stamina: 25 }),
  swordAir: A({ id: 'swordAir', label: 'Corte Aéreo', windup: 0.16, active: 0.12, recovery: 0.24, damage: 18, strength: 0.6, knockback: 5, hitStop: 0.07, shake: 0.28, arc: [150, -40], roll: 90, pitch: 0, lunge: 0, cancelAt: 0.1, whoosh: 0.7, bodyMotion: 0.35, overhead: true }),
  ...
  axeCharged: A({ id: 'axeCharged', label: 'Machadada Carregada', windup: 0.08, active: 0.12, recovery: 0.55, damage: 45, strength: 1, knockback: 6, hitStop: 0.15, shake: 0.6, arc: [105, -20], roll: -4, pitch: 22, pivot: 'chest', lunge: 0, cancelAt: 0.3, whoosh: 1, bodyTwist: 0.6, stamina: 25, work: 'chop' }),
