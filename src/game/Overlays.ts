...
export const CONTROLS_DESKTOP: [string, string][] = [
  ...
  ['Espaço (travado)', 'Esquiva — só com a mira travada: ←/→ salto lateral · parado/trás = pulo para trás (Ctrl/C/L também)'],
...
export const CONTROLS_TOUCH: [string, string][] = [
  ...
  ['Esquiva', 'Com a mira travada o botão Pular vira Esquiva: para o lado = salto lateral · solto = pulo para trás'],
